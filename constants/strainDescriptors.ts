...
export const STRAIN_DESCRIPTOR_DATABASE: Record<string, DescriptorColorMap> = {
  ...
  black: { hue: 230, saturationBoost: -20, lightnessBoost: -30, category: 'color' },
  midnight: { hue: 235, saturationBoost: -15, lightnessBoost: -25, category: 'color' },
  white: { hue: 0, saturationBoost: -20, lightnessBoost: 25, category: 'color' },
  silver: { hue: 0, saturationBoost: -15, lightnessBoost: 20, category: 'color' },
  platinum: { hue: 0, saturationBoost: -10, lightnessBoost: 22, category: 'color' },
